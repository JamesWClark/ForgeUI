...
parser_pre.add_argument("--output-dir", type=str, default=None, help="base path where generated outputs are stored; overrides --data-dir", )
...
default_output_dir = cmd_opts_pre.output_dir if cmd_opts_pre.output_dir else os.path.join(data_path, "outputs")
