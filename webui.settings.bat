...
set COMMANDLINE_ARGS=--api --autolaunch --autolaunch-chrome-incognito --cuda-malloc --port 7861 --data-dir "%~dp0data" --gradio-allowed-path "%~dp0." --models-dir "%~dp0models" --embeddings-dir "%~dp0embeddings" --ckpt-dir "%~dp0models\Stable-diffusion" --vae-dir "%~dp0models\VAE" --lora-dir "%~dp0models\Lora" --ui-settings-file "%~dp0data\config.json" --ui-config-file "%~dp0data\ui-config.json" --styles-file "%~dp0styles_integrated.csv"
